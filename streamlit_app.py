...
# Define your list of skills and keywords
skills_keywords = [
...
# Display Skills and Keywords in the Sidebar
st.sidebar.markdown("Skills and Keywords for Extraction:")
st.sidebar.write(", ".join(skills_keywords))
